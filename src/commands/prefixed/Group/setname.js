...
export const setup = {
  ...
  export const helping = {
    text: "Merubah nama group",
    use: `${prefix[0]}${fileName} *newNameGroup*`
  }
  ...
  export async function run(ctx, obj) {
    ...
    await ctx.groupUpdateSubject(obj.room.id, result)
    
    return ctx.sendMessage(
        obj.room.id,
        { text: `Nama group berhasil diubah menjadi *${result}*` },
